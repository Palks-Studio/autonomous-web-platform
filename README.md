...
- une architecture HTML/CSS/JS fidèle à un projet complet  
- un backend Flask (structure anonymisée)  
- une organisation modulaire professionnelle  
...
- a modular, agency-level organization  
...
Fully anonymized project structure (FR/EN), inspired by the real architecture.
...
- `public_version/` → full project structure (FR/EN)  
...
- only structure, organization, and methodology are shown
